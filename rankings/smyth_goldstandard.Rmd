...
# get overlaps
olaps <- InteractionSet::findOverlaps(smyth.sig, ours, use.region = 'same', minoverlap = 500000)
# make truth vector
...
sum(ours@elementMetadata$p.value < 0.05)
sum(ours@elementMetadata$p.adj < 0.05)
